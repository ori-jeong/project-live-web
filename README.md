...
### 2-1. 메인/카테고리
> 2-1-1. [[홈] 탭](#2-4-1-홈-탭)  
> 2-1-2. [[우리동네라이브] 탭](#2-4-2-우리동네라이브-탭)
### 2-2. 로그인 서비스  
> 2-2-1. [로그인에 따른 권한 처리](#2-1-1-로그인에-따른-권한-처리)  
> 2-2-2. [OAuth2와 JPA를 이용한 SNS 로그인](#2-1-2-oauth2와-jpa를-이용한-sns-로그인)  
### 2-3. 라이브 서비스
> 2-3-1. [NGINX 설정하기](#2-2-1-NGINX-설정하기)  
> 2-3-2. [OBS 사용하기](#2-2-2-OBS-사용하기)  
> 2-3-3. [라이브 영상 출력](#2-2-3-라이브-영상-출력)  
> 2-3-4. [FFmpeg, FFprobe로 라이브 영상 추출해 S3에 올리기](#2-2-4-ffmpeg-ffprobe로-라이브-영상-추출해-s3에-올리기)  
> 2-3-5. [라이브 종료 후 추출한 영상 보여주기](#2-2-5-라이브-종료-후-추출한-영상-보여주기)
### 2-4. 채팅 서비스
> 2-4-1. [라이브 채팅방 설정](#2-3-1-라이브-채팅방-설정)  
> 2-4-2. [채팅방 인원수 표시](#2-3-2-채팅방-인원수-표시)  
> 2-4-3. [판매자 채팅](#2-3-3-판매자-채팅)
### 2-5. 상품 선택 및 장바구니
...
## 🦄**1-4. 아키텍처**  
![아키텍처](https://user-images.githubusercontent.com/86868936/182414040-9517986c-76e8-4f55-b483-33ecb25b0615.png)
...
### 🍏**2-3-4. FFmpeg, FFprobe로 라이브 영상 추출해 S3에 올리기**
