...
> 1-5.  [사이트 주소 및 시연 영상](#1-5-사이트-주소-및-시연-영상)
...
> 2-2-4. [FFmpeg, FFfrobe로 라이브 영상 추출해 S3에 올리기](#2-2-4-FFmpeg,-FFfrobe로-라이브-영상-추출해-S3에-올리기)  
...
### 2-5. 상품 선택 및 장바구니
> 2-5-1. [상품 선택 및 장바구니](#2-4-1-상품-선택-및-장바구니)
### 2-6. 구매 서비스
> 2-6-1. [결제 API를 이용한 구매 서비스](#2-5-1-결제-API를-이용한-구매-서비스)
### 2-7. 마이페이지
> 2-7-1. [주문 목록](#2-6-1-주문-목록)
### 2-8. 판매자 관리툴
> 2-8-1. [라이브 등록: <우리동네라이브> 지역 설정](#2-7-1-라이브-등록:-<우리동네라이브>-지역-설정)
...
```
### 2-2-4. FFmpeg, FFfrobe로 라이브 영상 추출해 S3에 올리기
